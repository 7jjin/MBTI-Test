...
export const results = [
  {
    ...
    character: '/assets/assets/images/result_character1.png',
    results: [
    ...
    jobs: ['프리랜서', '창업가'],
    lectureImg: '/assets/assets/images/result_lecture1.png',
    lectureUrl: 'https://bit.ly/3Wr0kt6'
  },
  {
    title: '프로직진러!<br>진행력 갑',
    character: '/assets/assets/images/result_character2.png',
    results: [
    ...
    jobs: ['마케터', '기획자'],
    lectureImg: '/assets/assets/images/result_lecture2.png',
    lectureUrl: 'https://bit.ly/3SZl1t9'
  },
  {
    title: '우리 무기는<br>상상력!',
    character: '/assets/assets/images/result_character3.png',
    results: [
    ...
    jobs: ['디자이너', '예술가'],
    lectureImg: '/assets/assets/images/result_lecture3.png',
    lectureUrl: 'https://bit.ly/3DWlesG'
  },
  {
    title: '인생은<br>한방!',
    character: '/assets/assets/images/result_character4.png',
    results: [
    ...
    lectureImg: '/assets/assets/images/result_lecture4.png',
    lectureUrl: 'https://bit.ly/3fvoTo5'
  },
  {
    title: '한 번 집중하면<br>멈출 수 없지!',
    character: '/assets/assets/images/result_character5.png',
    results: [
    ...
    jobs: ['개발자', '데이터분석가'],
    lectureImg: '/assets/assets/btn-green/images/result_lecture5.png',
    lectureUrl: 'https://bit.ly/3U0O3Kj'
  },
  {
    title: '인생 욜로지~<br>일단 놀자 ><',
    character: '/assets/assets/images/result_character6.png',
    results: [
    ...
    jobs: ['돈 많은 백수', '유튜버'],
    lectureImg: '/assets/assets/images/result_lecture6.png',
